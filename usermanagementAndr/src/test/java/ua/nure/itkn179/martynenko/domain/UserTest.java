package ua.nure.itkn179.martynenko.domain;
...
public class UserTest extends TestCase {
    ...
    //“ест2 - день рождени€ прошел но мес€ц др еще идет
    ...
    // “ест4 - день рождени€ в этом мес€це еще не настал
    ...
    // “ест5 - день рождени€ не настал в этом мес€це но будет в другом.
