...
import ua.nure.kn.martynenko.usermanagment.db.ConnectionFactory;
import ua.nure.kn.martynenko.usermanagment.db.ConnectionFactoryImpl;
import ua.nure.kn.martynenko.usermanagment.db.DatabaseException;
import ua.nure.kn.martynenko.usermanagment.db.HsqldbUserDao;
...
public class HsqldbUserDaoTest extends DatabaseTestCase {
    ...
    private static final String UPDATED_FIRST_NAME = "Dron";

    private static final String LAST_NAME = "Doe";
    private static final String UPDATED_LAST_NAME = "Ashotovich";
